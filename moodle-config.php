...
$CFG->dbtype    = getenv('DB_TYPE');      // 'pgsql', 'mariadb', 'mysqli', 'sqlsrv' or 'oci'
...
$CFG->prefix    = getenv('TBL_PREFIX');       // prefix to use for all table names
$CFG->dboptions = array(
    'dbpersist' => getenv('DB_PERSIST'),       // should persistent database connections be
